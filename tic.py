...
root = Tk()
root.title("tic tac toy : player")
style=ttk.Style()
style.theme_use('classic')

bu1= ttk.Button(root,text=' ')
bu1.grid(row=0,column=0,sticky='snew',ipadx=10,ipady=40)
bu1.config(command=lambda : Buclick(1))

bu2= ttk.Button(root,text=' ')
bu2.grid(row=0,column=1,sticky='snew',ipadx=10,ipady=40)
bu2.config(command=lambda : Buclick(2))

bu3= ttk.Button(root,text=' ')
bu3.grid(row=0,column=2,sticky='snew',ipadx=10,ipady=40)
bu3.config(command=lambda : Buclick(3))

bu4= ttk.Button(root,text=' ')
bu4.grid(row=1,column=0,sticky='snew',ipadx=10,ipady=40)
bu4.config(command=lambda : Buclick(4))

bu5= ttk.Button(root,text=' ')
bu5.grid(row=1,column=1,sticky='snew',ipadx=10,ipady=40)
bu5.config(command=lambda : Buclick(5))

bu6= ttk.Button(root,text=' ')
bu6.grid(row=1,column=2,sticky='snew',ipadx=10,ipady=40)
bu6.config(command=lambda : Buclick(6))

bu7= ttk.Button(root,text=' ')
bu7.grid(row=2,column=0,sticky='snew',ipadx=10,ipady=40)
bu7.config(command=lambda : Buclick(7))

bu8= ttk.Button(root,text=' ')
bu8.grid(row=2,column=1,sticky='snew',ipadx=10,ipady=40)
bu8.config(command=lambda : Buclick(8))

bu9= ttk.Button(root,text=' ')
bu9.grid(row=2,column=2,sticky='snew',ipadx=10,ipady=40)
...
def Buclick(id):
    ...
    if (ActivePlayer == 1):
        SetLayout(id,'X')
        p1.append(id)
        root.title('tic tac toy : plater 2 ')
        ActivePlayer = 2
        print('p1 : {}'.format(p1))
    elif (ActivePlayer == 2):
        SetLayout(id,'O')
